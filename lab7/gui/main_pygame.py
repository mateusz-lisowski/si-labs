from .manual_pygame_agent import QuitException, ManualPygameAgent
...
def main_pygame(env: Env, agent: Agent, max_ep_len=50, save_path=None, render=False,
    ...
    while running:
        ...
        if avr_rew > best_average_rew:
            ...
            print(
                f"After {i_episode} episodes, new best last 10 ep. avg rew: {avr_rew:05f}, avg steps/ep: {avr_steps:.2f}")
        i_episode += 1
